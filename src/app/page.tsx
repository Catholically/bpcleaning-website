        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <a
              ...
              className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-[#0d9488]/30 transition group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-[#0d9488]">Gestione Qualità</p>
                  <p className="text-xs text-gray-500 mt-1">Processi standardizzati per garantire servizi di alta qualità</p>
                </div>
              </div>
            </a>
            <a
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-[#0d9488]">Sicurezza sul Lavoro</p>
                  <p className="text-xs text-gray-500 mt-1">Personale formato e ambienti di lavoro sicuri</p>
                </div>
              </div>
            </a>
          </div>
