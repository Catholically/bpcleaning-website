...
export const metadata: Metadata = {
  title: "Guide Pulizie Professionali | BP Cleaning",
  description:
    "Guide complete sulla pulizia professionale di uffici, condomini, hotel, ristoranti e ambienti commerciali. Tecniche, protocolli e consigli degli esperti.",
  alternates: {
    canonical: "https://www.bpcleaning.it/blog/guide",
  },
};
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">
              Guide Pulizie Professionali
            </h1>
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Guide complete e approfondite sulla pulizia professionale per ogni
              tipo di ambiente e settore.
            </p>
          </div>
        </div>
      </section>
